...
- **MapMarkerStyle**: The style of marker to use for the items on the map: "pins" (default pin markers) or "circles". Legacy values "default", "dot", and "dots" are also accepted. Default is "pins".
